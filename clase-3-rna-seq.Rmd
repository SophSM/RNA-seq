...
Convertir de gtf de genecode a tablas donde solo agarro los nombres de los transcritos y sus genes correspondientes.
...
sucede cuando se divide entre el numero total de cuentas en cada muestra y en una muestra hay un gen con gran cantidad de reads, sucede entre muestras distintas, también por contaminación o diferencias en el número de genes expresados (PCR)
